      ...
      <div className="max-w-6xl mx-auto p-6 lg:p-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
          <div>
            ...
            <p className="text-gray-400 font-bold uppercase text-xs tracking-[0.2em]">Share insights and ask anything</p>
          </div>
          <button
          ...
          <div className="space-y-6">
            ...
            {!questions.length && !loading && (
              <div className="py-20 text-center bg-white rounded-[40px] border-4 border-dashed border-gray-50">
                <p className="text-gray-300 font-black text-2xl tracking-tight">No discussions yet. Be the first!</p>
              </div>
            )}
          </div>
        )}
